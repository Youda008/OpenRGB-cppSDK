...
enum class ConnectStatus
{
	...
	OTHER                    ///< Other system error. Call getLastSystemError() for more info.
};
...
class Client
{
 ...
 private:
	...
	// pointer just so that we don't have to include the TcpSocket and all its OS dependancies here
