...
make orgbcli
```
The tool can either be controlled by command line arguments or interactively while running. Write `orgbcli --help` to learn more about the usage or start the tool without arguments and follow instructions.
